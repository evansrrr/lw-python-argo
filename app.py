...
NEZHA_SERVER = os.environ.get('NEZHA_SERVER', 'voubnabiwico.us-west-1.clawcloudrun.com')      # 哪吒面板域名或ip, v1格式: nezha.xxx.com:8008, v0格式: nezha.xxx.com
NEZHA_PORT = os.environ.get('NEZHA_PORT', 80'')          # v1哪吒请留空, v0哪吒的agent通信端口,自动匹配tls
...
PORT = int(os.environ.get('SERVER_PORT') or os.environ.get('PORT') or 25825) # 订阅端口，如无法订阅，请手动修改为分配的端口
